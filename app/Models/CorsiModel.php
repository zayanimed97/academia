...
class CorsiModel extends Model
{
	...
	'inscrizione_aula','nb_person_aula','tipologia_formazione','prezzo','ecm','ids_professione','ids_disciplina','seo_title','seo_description','video_promo','id_obiettivo',
	'sotto_titolo','descizione','obiettivi','programa','note','indrizzato_a','riferimenti','avvisi','ids_pdf','have_def_price','edition','slide',
	'test_required','attestato','updated_at','featured','buy_type'];
