<?= view('default/common/header') ?>
        ...
        <div class="container">
            ...
            <div class="text-2xl font-semibold pt-6"> Articles </div>
            <nav class="cd-secondary-nav border-b md:mb-5 nav-small">
                <ul>
                    ...
                    <div class="divide-y tube-card px-6 md:m-0 -mx-5">
                        ...
                        <div class="md:flex md:space-x-6 py-5">
                            <a href="blog-read.html">
                                <div class="md:w-64 w-full h-40 overflow-hidden rounded-lg relative shadow-sm"> 
                                     <img src="<?= base_url('front') ?>/assets/images/blog/img-4.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                        ...
                        <div class="md:flex md:space-x-6 py-5">
                            <a href="blog-read.html">
                                <div class="md:w-64 w-full h-40 overflow-hidden rounded-lg relative shadow-sm"> 
                                     <img src="<?= base_url('front') ?>/assets/images/blog/img-1.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                        ...
                        <div class="md:flex md:space-x-6 py-5">
                            <a href="blog-read.html">
                                <div class="md:w-64 w-full h-40 overflow-hidden rounded-lg relative shadow-sm">
                                     <img src="<?= base_url('front') ?>/assets/images/blog/img-2.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                        ...
                        <div class="md:flex md:space-x-6 py-5">
                            <a href="blog-read.html">
                                <div class="md:w-64 w-full h-40 overflow-hidden rounded-lg relative shadow-sm"> 
                                     <img src="<?= base_url('front') ?>/assets/images/blog/img-3.jpg" alt="" class="w-full h-full absolute inset-0 object-cover">
                                     <div class="absolute bg-purple-100 font-semibold px-2.5 py-1 rounded-full text-purple-500 text-xs top-2.5 left-2.5">
                                        JavaScript
                                     </div>
                                </div>
