                                            ...
                                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="row pt-1">
                                                        <?php /*    <button type="button" data-toggle="modal" data-target="#update-argomenti-modal" onclick="updateID(<?= $arg['idargomenti'] ?>, '<?= $arg['nomeargomento'] ?>')" class="btn p-1 mr-2" style="font-size: 1rem">
                                                                <i class="fe-edit"></i>
                                                            </button>
