<?= view('admin/common/header',array('page_title'=>lang('app.title_page_cours_test_edit'))) ?>
...
<link href="<?php echo base_url('UBold_v4.1.0')?>/assets/libs/datatables.net-select-bs4/css//select.bootstrap4.min.css" rel="stylesheet" type="text/css" />
            ...
            <div class="content-page">
                <div class="content">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
											 ...
											 <li class="breadcrumb-item"><a href="<?php echo base_url('admin/test')?>"><?php echo lang('app.menu_corsi_test')?></a></li
											  <li class="breadcrumb-item active"><?php echo lang('app.edit_test')?></li>
                                        </ol>
                                    </div>
                                    <div class="row align-items-center">
                                        <h4 class="page-title"><?= lang('app.title_page_cours_test_edit') ?></h4>
					...
					echo form_open_multipart( base_url('admin/test/edit/'.$inf_test['id']), $attributes);
				
					?>
					<input type="hidden" name="id" value="<?php echo $inf_test['id']?>">
						<div class="row">
							<div class="col-md-4">	
								...
								<select class="form-control" id="type" name="type" onchange="return get_type(this.value)">
									...
									<option value="modulo" <?php if($inf_test['type']=='modulo') echo 'selected'?>><?php echo lang('app.field_test')?></option>
									<option value="quality" <?php if($inf_test['type']=='quality') echo 'selected'?>><?php echo lang('app.field_test_quality')?></option>
							...
							<div class="col-md-6">	
								...
								<input type="text" class="form-control"  id="title" name="title" placeholder="<?php echo lang('app.field_question')?>" value="<?php echo $inf_test['title']?>">
							</div>
							
							
							<div class="col-md-2">	
								<label><?php echo lang('app.field_sort')?> </label>
								<input type="number" step="1" min="1" class="form-control" value="<?php echo $inf_test['ord']?>" id="ord" name="ord" placeholder="<?php echo lang('app.field_order')?>">
							</div>
						</div>
						<div class="row" id="div_modulo" <?php if($inf_test['type']=='quality'){?> style="display:none"<?php } ?>>
							<div class="col-md-4" style="margin-top:25px">
							<div class="form-check form-check-inline">
											<?php 
											if($inf_test['auto_score']=='yes') $chk=true; else $chk=false;
							...
							<div class="col-md-4">	
								...
								<input type="number" step="1" min="1" class="form-control" value="<?php echo $inf_test['min_points']?>" id="min_points" name="min_points">
							</div>
							<div class="col-md-4">	
								<label><?php echo lang('app.field_nb_repeat')?> </label>
								<input type="number" step="1" min="0" class="form-control" value="<?php echo $inf_test['nb_repeat']?>" id="nb_repeat" name="nb_repeat" >
							</div>
						</div>
                        <div class="repeater-default m-t-30">
                                    <div data-repeater-list="questions">
								   <?php foreach($list_questions as $one_q){?>
											<div data-repeater-item="">
												<input type="hidden" name="question_id" value="<?php echo $one_q['id']?>" style="width:60px" >
                                                <div class="form-row">
                                                    <div class="col-12 col-lg-6">
														<div class="card">
															<div class="card-body">
																<div class="alert alert-danger alert-danger-question" role="alert" style="display:none"></div>
																<h4 class="card-title"><?php echo lang('app.field_question')?> <input type="hidden" name="question_index" value="1" style="width:60px"  disabled></h4>
															  
																<div class="row">	
																	<div class="col-md-12">	
																		<input type="text" class="form-control question" id="question_title" name="question_title" placeholder="<?php echo lang('app.field_question')?>" value="<?php echo $one_q['question']?>">
																	</div>
																</div>
																<div class="row  m-t-10">	
																	<div class="col-md-6">	
																		<select class="form-control question" id="question_type" name="question_type">
																			...
																			<option value="unica" <?php if($one_q['type']=='unica') echo 'selected'?>>unica</option>
																			<option value="multipla" <?php if($one_q['type']=='multipla') echo 'selected'?>>multipla</option>
																			<option value="aperta" <?php if($one_q['type']=='aperta') echo 'selected'?>>aperta</option>
																		</select>
																	</div>
																	<div class="col-md-6">	
																		<select class="form-control question" id="question_time" name="question_time" >
																			...
																			<option value="<?php echo $i?>" <?php if($one_q['time']==$i) echo 'selected'?>><?php echo $i?></option>
																			<?php } ?>
																		</select>
																	</div>
																</div>
															...
															<div class="card-body">
																	...
																	<div class="">
																		...
																		<div class="alert alert-danger alert-danger-question-answer" role="alert" style="display:none"></div>
																			...
																			<?php foreach($list_responses[$one_q['id']] as $one_answer){?>
																				<div data-repeater-item class="row m-b-15">
																				<input type="hidden" name="answer_id" value="<?php echo $one_answer['id']?>" style="width:60px" >
																				<h4 class="card-title col-md-12"><?php echo lang('app.field_response')?><input type="hidden" name="answer_index" value="1" style="width:60px"  disabled></h4>
																					<div class="col-md-8">
																						<input type="text" class="form-control" id="answer_title" name="answer_title" placeholder="<?php echo lang('app.field_response_title')?>" value="<?php echo $one_answer['response']?>">
																					</div>
																					<div class="col-md-2">
																						<input type="text" class="form-control" id="answer_points" name="answer_points" placeholder="<?php echo lang('app.field_response_points')?>" value="<?php echo $one_answer['points']?>">
																					</div>
																					<div class="col-md-2 ">
										...
										<?php }// end foreach list_questions
									?>
                                    </div>
