<?= view('admin/common/header',array('page_title'=>lang('app.title_page_settings_remember_emails_edit'))) ?>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
											...
											<li class="breadcrumb-item active"><?php echo lang('app.menu_setting_remember_email_edit')?></li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?php echo lang('app.title_page_settings_remember_emails_edit')?></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
							 ...
							 <?php //echo $validation->listErrors()
									...
									<div class="col-md-12">
														...
														echo form_dropdown($input, $options,$inf['tipologia_corsi'],$js);
														?>
												...
												<div class="col-md-6" id="div_type_days" <?php if(in_array($inf['tipologia_corsi'],array('online','eBook'))){?>style="display:none"<?php } ?>>
													<div class="form-group">
									...
									<div class="col-md-12">
										 ...
										 <div class="checkbox form-check-inline">
																			<input type="checkbox" name="enable" id="enable" value="yes" <?php if($inf['enable']=='yes') echo 'checked'?>>
