...
<?php $attributes = ['class' => 'form-input-flat', 'id' => 'add_corsi_form','method'=>'post'];
										...
										?>
										 ...
										 <div class="col-md-4"  id="div_luoghi" style="display:none">
																<div class="form-group required-field">
											...
											<div class="col-md-4" id="div_alberghi" style="display:none">
														 ...
														 <div class="row">
															 ...
															 <div class="col-12">
                                                                <div class="form-group row mb-3">
                                                                    ...
                                                                    <div class="col-md-9">
																		<div class="radio form-check-inline" id="div_buy_type_date" style="display:none">
																			<input type="radio" name="buy_type" id="buy_type_date" value="date"  >
                                                    ...
                                                    <div id="profileForm" >
															<div class="row">
																  <div class="col-sm-11">
																	...
																	<a href="#list-modal-dialog" data-toggle="modal"  name="list" id="listPdfs" class="btn btn-warning float-right"><?php echo  lang('app.btn_list')?></a>
