                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5 class="mt-0"><?= lang('app.field_sottoargomenti') ?></h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="row pt-1">
                                                            ...
                                                            <a href="<?= base_url() ?>/admin/deleteSottoargomenti/<?= $arg['id'] ?>" class="p-1" style="height: fit-content; font-size: 1rem; color: red">
