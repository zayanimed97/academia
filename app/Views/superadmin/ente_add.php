...
<?php $attributes = ['class' => 'form-input-flat', 'id' => 'add_ente_form','method'=>'post'];
                               ...
                               <div class="col-6">
								...
								<div class="col-12">
												...
												<div class="tab-pane fade" id="fourth">
													...
													<div class="row">
															<div class="col-12">
																		...
																		<div class="radio form-check-inline">
																			<input type="radio" name="type" id="type_professional" value="professional"  onclick="return get_type('professional')">
														...
														<div class="row">
															 <div class="col-4" id="div_company" style="display:none">
														 <div class="form-group row mb-3">
                                  ...
                                  <div class="col-4" id="div_piva" style="display:none">
														 <div class="form-group row mb-3">
								...
								<div class="col-4" id="div_cf" >
									...
									<div class="row">
																  <div class="col-6"  id="div_fattura_nome">
														 <div class="form-group row mb-3">
									<label class="col-md-3 col-form-label" for="acc-name"><?php echo lang('app.field_first_name')?></label>
									<div class="col-md-9">
										<?php $val=""; 
                                  ...
                                  <div class="col-6" id="div_fattura_cognome">
														 <div class="form-group row mb-3">
									<label class="col-md-3 col-form-label" for="acc-name"><?php echo lang('app.field_last_name')?></label>
                                   <div class="col-md-9">
								        <?php $val=""; 
...
<div class="col-4" >
														 <div class="form-group row mb-3" id="div_sdi" style="display:none">
...
function get_provincia(t,v,selected=''){
			...
			$.ajax({
				...
				/*	var xxx="<label class='col-form-label col-sm-3'><?php echo lang('app.field_city')?></label><div class='col-sm-6'><input type='text' name='residenza_comune' id='residenza_comune' class='form-control form-control-sm'></div>";*/
					var xxx="<input type='text' name='fattura_comune' id='fattura_comune' class='form-control'>";
