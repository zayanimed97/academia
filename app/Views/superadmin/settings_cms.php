                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo lang('app.title_page_settings_cms')?></h4>
                                         ...
                                         <table id="scroll-horizontal-datatable" class="table w-100 nowrap" >
											...
											<?php foreach($list as $k=>$one_customer){?>
													<tr class="odd gradeX">
														...
														<a href="<?php echo base_url('superadmin/settings/cms/edit/'.$one_customer['id'])?>" class="btn p-1 mr-2" style="font-size: 1rem">
                                                                <i class="fe-edit"></i>
                                                            </a>
